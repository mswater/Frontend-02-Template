...
export class Recognizer{
    ...
    move(point, context){
        ...
        if(dx ** 2 + dy ** 2 > 100){
            ...
            if(context.isPress){
                this.dispatcher.dispatch("pressmove", {
        ...
        if(context.isTap){
            ...
            console.log("this is a tap action");
        }else if(!context.isFlip && context.isPress){
            this.dispatcher.dispatch("press", {});
            console.log("this is a press action");
        }else if(!context.isFlip && context.isPan){
            ...
            console.log("this is a pan action");
        }
